...
def get_code_analysis_guidance(query:str)->str:
    ...
    """
    return "Focus on: syntax, logic erros, performance, readability and best practices."
...
st.title("Code Analyzer App(LangGraph + LLM)")
...
if user_code:
    try:
        ...
        with st.expander("Context Used"):
            st.text(result.get("context","No context generated."))
